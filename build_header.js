...
import { Menu, X, Phone, MessageSquare, ChevronRight, User } from "lucide-react";
        ...
        <div className="h-16 max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              >
                <span className="material-symbols-outlined text-secondary-accent text-[18px]">call</span>
            ...
            <div className="pt-4 border-t border-surface-container space-y-3">
              ...
              >
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-secondary-accent text-[20px]">call</span>
                  <span>+971 4 288 8490</span>
                </div>
              ...
              >
                ...
                <span className="text-xs uppercase font-label-caps text-secondary-accent font-bold">Online</span>
              </a>
...
console.log('src/components/Header.tsx written.');
